...
class DoctorAppointment extends StatefulWidget {
  ...
  const DoctorAppointment({Key? key, required this.name, required this.speciality,
    required this.patients, required this.location, }) : super(key: key);
          ...
          Column(
              ...
              children:[
                ...
                Expanded(
                  child: ListView(
                    children: [
                      SecondaryButton(child: Text("Select Date",style:TextStyle(fontWeight: FontWeight.bold,
                          fontSize: 16)),
                          onPressed: ()async{
                       await showDatePicker(
                         ...
                         if (selectedDate != null) {
                           setState(() {
                             ...
                             timeSlot=true;
                             dateget = DateFormat('d-MMM-yy').format(selectedDate);
                           });
                         }
                       }
                       );
                          }, color: Colors.pink,backgroundColor:Colors.pink),
                ...
                SecondaryButton(onPressed:!dateConfirm?null:
                    (){
                ...
                }, color: Colors.amberAccent,backgroundColor:Colors.amberAccent ,
